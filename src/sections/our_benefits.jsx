...
export default function Our_benefits({in_home=false}) {
  return (
    <div className={`our-benefuts ${in_home?'mt-[50px] mb-[20px] ':'my-[100px]'} `} >
        ...
        <TextTranslater txt='nega-title' txt_styles={` text-white md:text-[45px] sm:text-[30px] text-[23px] font-[700] mx-auto my-[20px] text-center max-w-[900px] w-[100%] `} />
        <TextTranslater txt='afzalligimiz' txt_styles={` text-[#6c2dba] md:text-[40px] sm:text-[25px] text-[18px] font-[700] mx-auto my-[20px] mb-[50px] text-center max-w-[900px] w-[100%] `} />
        <div className="container grid lg:grid-cols-3 sm:grid-cols-2 grid-cols-1 xl:gap-[20px] lg:gap-[10px] gap-[25px] ">


            <div className="benefit-card flex gap-[20px] bg-[#121111] rounded-[15px] xl:p-[35px] p-[20px] ">
                <div className="icons flex flex-col gap-[30px]  ">
                    <span className=' text-white text-[45px] font-[700] ' >
                    ...
                    <span className=' text-white text-[25px] ' >01</span>
                </div>
                <div className="texts flex flex-col gap-[10px]  ">
                    <TextTranslater txt='afzal1-title' txt_styles=' text-white text-[23px] font-[600] ' />
                    <TextTranslater txt='afzal1-txt' txt_styles=' text-gray-400 text-[14px] ' />
                </div>
            </div>
            ...
            <div className="benefit-card flex gap-[20px] bg-[#121111] rounded-[15px] xl:p-[35px] p-[20px] ">
                <div className="icons flex flex-col gap-[30px]  ">
                    ...
                    <span className=' text-white text-[25px] ' >02</span>
                </div>
                <div className="texts flex flex-col gap-[10px]  ">
                    <TextTranslater txt='afzal2-title' txt_styles=' text-white text-[23px] font-[600] ' />
                    <TextTranslater txt='afzal2-txt' txt_styles=' text-gray-400 text-[14px] ' />
                </div>
            </div>
            ...
            <div className="benefit-card flex gap-[20px] bg-[#121111] rounded-[15px] xl:p-[35px] p-[20px] ">
                <div className="icons flex flex-col gap-[30px]  ">
                    ...
                    <span className=' text-white text-[25px] ' >03</span>
                </div>
                <div className="texts flex flex-col gap-[10px]  ">
                    <TextTranslater txt='afzal3-title' txt_styles=' text-white text-[23px] font-[600] ' />
                    <TextTranslater txt='afzal3-txt' txt_styles=' text-gray-400 text-[14px] ' />
                </div>
            </div>
            ...
            <div className="benefit-card flex gap-[20px] bg-[#121111] rounded-[15px] xl:p-[35px] p-[20px] ">
                <div className="icons flex flex-col gap-[30px]  ">
                    ...
                    <span className=' text-white text-[25px] ' >04</span>
                </div>
                <div className="texts flex flex-col gap-[10px]  ">
                    <TextTranslater txt='afzal4-title' txt_styles=' text-white text-[23px] font-[600] ' />
                    <TextTranslater txt='afzal4-txt' txt_styles=' text-gray-400 text-[14px] ' />
                </div>
            </div>
            ...
            <div className="benefit-card flex gap-[20px] bg-[#121111] rounded-[15px] xl:p-[35px] p-[20px] ">
                <div className="icons flex flex-col gap-[30px]  ">
                    ...
                    <span className=' text-white text-[25px] ' >05</span>
                </div>
                <div className="texts flex flex-col gap-[10px]  ">
                    <TextTranslater txt='afzal5-title' txt_styles=' text-white text-[23px] font-[600] ' />
                    <TextTranslater txt='afzal5-txt' txt_styles=' text-gray-400 text-[14px] ' />
                </div>
            </div>
            ...
            <div className="benefit-card flex gap-[20px] bg-[#121111] rounded-[15px] xl:p-[35px] p-[20px] ">
                <div className="icons flex flex-col gap-[30px]  ">
                    ...
                    <span className=' text-white text-[25px] ' >06</span>
                </div>
                <div className="texts flex flex-col gap-[10px]  ">
                    <TextTranslater txt='afzal6-title' txt_styles=' text-white text-[23px] font-[600] ' />
                    <TextTranslater txt='afzal6-txt' txt_styles=' text-gray-400 text-[14px] ' />
                </div>
            </div>
